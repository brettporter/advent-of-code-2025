...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 2](./src/bin/02.rs) | `5.3µs` | `27.3µs` |
| [Day 3](./src/bin/03.rs) | `66.4µs` | `1.1ms` |
| [Day 4](./src/bin/04.rs) | `450.6µs` | `5.4ms` |
| [Day 5](./src/bin/05.rs) | `205.9µs` | `33.8µs` |
| [Day 6](./src/bin/06.rs) | `402.2µs` | `405.3µs` |
| [Day 7](./src/bin/07.rs) | `353.2µs` | `382.7µs` |
| [Day 8](./src/bin/08.rs) | `113.3ms` | `114.2ms` |
| [Day 9](./src/bin/09.rs) | `8.9ms` | `86.7ms` |
